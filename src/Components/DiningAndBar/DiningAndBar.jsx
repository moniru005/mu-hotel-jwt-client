...
const DiningAndBar = () => {
  return (
    <div className="pt-16 lg:pt-28 max-w-[1200px] mx-auto pb-16 font-workSans">
    {/* Row-1 */}
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row px-4 lg:px-0 items-center">
        <div className="w-full lg:w-1/2 pb-6 lg:pb-0">
            ...
            <h2 className="text-center lg:text-left text-2xl lg:text-4xl font-semibold pb-3">Dining & Bars</h2>
    ...
    {/* Row-2 */}
      <div className="max-w-6xl pt-12 mx-auto flex flex-col lg:flex-row-reverse px-4 lg:px-0 items-center">
        <div className="w-full lg:w-1/2 pb-6 lg:pb-0">
            ...
            <h2 className="text-center lg:text-left text-2xl lg:text-4xl font-semibold pb-3">Wellness & SPA</h2>
            <p className="text-justify  ">
